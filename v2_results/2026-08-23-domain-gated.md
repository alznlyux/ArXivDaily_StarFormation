...
- **A dual-polarization whitened-template trigger for real-time radio detection of extensive air showers** — C→SKIP; `generic_instrumentation`; evidence 0.00 — [2608.19898](https://arxiv.org/abs/2608.19898)
- **Nuclear Drip Line and the Composition of Supernova Matter** — C→SKIP; `dense_nuclear_matter`; evidence 0.00 — [2608.16778](https://arxiv.org/abs/2608.16778)
- **A Social Network Analysis of JWST General Observer Programs: The Emergence of a Decentralized Heterarchy** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.15883](https://arxiv.org/abs/2608.15883)
- **Finding Habitable Exoplanets with Binary Relative Astrometry: Planet Detection and Characterization with the Microarcsecond Astrometric Retrieval Algorithm (MARA)** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.19444](https://arxiv.org/abs/2608.19444)
- **The detection prospects of the polarizations in the plateau phase of GRB afterglow by eXTP** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.15485](https://arxiv.org/abs/2608.15485)

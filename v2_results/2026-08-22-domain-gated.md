...
Generated: 2026-08-22T15:48:44Z
Lookback: last 10 days

## Summary

- Candidates: **493**
- Current keyword baseline: **65**
- A: **4**
- B: **32**
- C: **32**
- SKIP: **425**
- Downgraded by domain gate: **98**
- Rescued by domain evidence: **3**

## A/B candidates

### [A] 88.1 — ALOHA IRDCs Molecular Line Follow-up: I. Gas properties and kinematics
- **arXiv:** [2608.20238](https://arxiv.org/abs/2608.20238)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7783 / `planetary_disks_exoplanets` 0.7266
- **Margin:** +0.0517
- **Domain evidence:** 14.00 (title 4.50)
- **Gate:** A → A — contrastive
...
### [A] 81.8 — CHANG-ES XL: Magnetic Field Structures in the Disk and Halo of NGC 891
- **arXiv:** [2608.12275](https://arxiv.org/abs/2608.12275)
- **Primary:** astro-ph.GA
- **Positive / negative:** `magnetic_fields` 0.7728 / `planetary_disks_exoplanets` 0.7352
- **Margin:** +0.0376
- **Domain evidence:** 6.00 (title 0.00)
- **Gate:** A → A — contrastive
...
### [A] 74.1 — Impact of Upstream Clumpiness on Supernova Remnant Forward Shock Evolution in Molecular Cloud Environments
- **arXiv:** [2608.17477](https://arxiv.org/abs/2608.17477)
- **Primary:** astro-ph.HE
- **Positive / negative:** `turbulence` 0.7540 / `relativistic_plasma_transients` 0.7285
- **Margin:** +0.0255
- **Domain evidence:** 4.50 (title 4.50)
- **Gate:** A → A — contrastive
...
### [A] 71.1 — Star Formation in the H II Region Sh 2-205: 3D Morphology and Kinematics from Young Stars and Molecular Gas
- **arXiv:** [2608.16179](https://arxiv.org/abs/2608.16179)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7679 / `planetary_disks_exoplanets` 0.7464
- **Margin:** +0.0214
- **Domain evidence:** 12.25 (title 9.75)
- **Gate:** A → A — contrastive
...
### [B] 76.7 — Automated Assignment and Prediction of Molecules in Astronomical Line Surveys Using Machine-Learning-Based Chemical Embeddings
- **arXiv:** [2608.18221](https://arxiv.org/abs/2608.18221)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7611 / `planetary_disks_exoplanets` 0.7277
- **Margin:** +0.0334
- **Domain evidence:** 5.50 (title 0.00)
...
### [B] 73.5 — Complex morphology and kinematics at the heart of the very low luminosity object IRAM 04191+1522
- **arXiv:** [2608.17593](https://arxiv.org/abs/2608.17593)
- **Primary:** astro-ph.SR
- **Positive / negative:** `molecular_clouds` 0.7678 / `planetary_disks_exoplanets` 0.7571
- **Margin:** +0.0107
- **Domain evidence:** 10.00 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 72.1 — Diffuse HI emission in the circumgalactic medium of NGC891 and NGC4565 - III: azimuthal profiles
- **arXiv:** [2608.19186](https://arxiv.org/abs/2608.19186)
- **Primary:** astro-ph.GA
- **Positive / negative:** `galactic_ism_surveys` 0.7573 / `stellar_atmospheres_evolution` 0.7307
- **Margin:** +0.0266
- **Domain evidence:** 4.50 (title 4.50)
- **Gate:** B → B — contrastive
...
### [B] 70.7 — Multiphase turbulence as the origin of OH+, H2O+ and H3+ column density scatter in the local ISM
- **arXiv:** [2608.15633](https://arxiv.org/abs/2608.15633)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7647 / `galaxy_evolution_agn` 0.7515
- **Margin:** +0.0131
- **Domain evidence:** 7.50 (title 3.00)
- **Gate:** B → B — contrastive
...
### [B] 70.2 — Infrared Spectroscopy of Cyanonaphthalenes under Interstellar Relevant Conditions and Their Potential Connection with Astronomical Aromatic Infrared Bands
- **arXiv:** [2608.14964](https://arxiv.org/abs/2608.14964)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7605 / `planetary_disks_exoplanets` 0.7239
- **Margin:** +0.0367
- **Domain evidence:** 2.50 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 69.9 — The Nearby Star Formation and Supernova Histories Reconstructed from Young Star Clusters
- **arXiv:** [2608.20307](https://arxiv.org/abs/2608.20307)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7447 / `planetary_disks_exoplanets` 0.7292
- **Margin:** +0.0155
- **Domain evidence:** 4.75 (title 2.25)
- **Gate:** B → B — contrastive
...
### [B] 69.3 — The Galactic Centre G+0.633-0.0604 Molecular Cloud: A New Gold Mine for Astrochemistry
- **arXiv:** [2608.14381](https://arxiv.org/abs/2608.14381)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7769 / `planetary_disks_exoplanets` 0.7615
- **Margin:** +0.0154
- **Domain evidence:** 7.00 (title 4.50)
- **Gate:** B → B — contrastive
...
### [B] 68.6 — Observing Co-Located Neutral and Ionized Gas-Phase Iron Depletion in the Magellanic Clouds
- **arXiv:** [2608.12557](https://arxiv.org/abs/2608.12557)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7663 / `planetary_disks_exoplanets` 0.7580
- **Margin:** +0.0083
- **Domain evidence:** 6.50 (title 0.00)
- **Gate:** B → B — contrastive
...
- **Primary:** astro-ph.GA
- **Positive / negative:** `turbulence` 0.7473 / `generic_instrumentation` 0.7141
- **Margin:** +0.0332
- **Domain evidence:** 0.00 (title 0.00)
- **Gate:** B → B — contrastive
...
- **Primary:** astro-ph.SR
- **Positive / negative:** `magnetic_fields` 0.7591 / `galaxy_evolution_agn` 0.7277
- **Margin:** +0.0314
- **Domain evidence:** 0.00 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 67.5 — The CMZ Asymmetries: Feeding or Feedback?
- **arXiv:** [2608.13734](https://arxiv.org/abs/2608.13734)
- **Primary:** astro-ph.GA
- **Positive / negative:** `molecular_clouds` 0.7210 / `cosmology_large_scale_structure` 0.7034
- **Margin:** +0.0176
- **Domain evidence:** 2.50 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 67.3 — JWST Whirlpool Galaxy Treasury: Mid-Infrared Emission in M51 and its Relation to Gas Column and Star Formation
- **arXiv:** [2608.16802](https://arxiv.org/abs/2608.16802)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7553 / `galaxy_evolution_agn` 0.7498
- **Margin:** +0.0055
- **Domain evidence:** 7.25 (title 2.25)
- **Gate:** B → B — contrastive
...
### [B] 66.0 — Aromatics and Aliphatics in Local Star-Forming Galaxies as Probed by AKARI
- **arXiv:** [2608.14989](https://arxiv.org/abs/2608.14989)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7795 / `planetary_disks_exoplanets` 0.7489
- **Margin:** +0.0307
- **Domain evidence:** 1.50 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 65.1 — OH Line Detections in Southern Galaxies of the IRAS Revised Bright Galaxy Sample
- **arXiv:** [2608.14473](https://arxiv.org/abs/2608.14473)
- **Primary:** astro-ph.GA
- **Positive / negative:** `galactic_ism_surveys` 0.7474 / `generic_instrumentation` 0.7347
- **Margin:** +0.0127
- **Domain evidence:** 4.00 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 65.0 — The segmented spiral structure of the Solar neighbourhood traced by young clustered populations
- **arXiv:** [2608.17887](https://arxiv.org/abs/2608.17887)
- **Primary:** astro-ph.GA
- **Positive / negative:** `galactic_ism_surveys` 0.7379 / `galaxy_evolution_agn` 0.7308
- **Margin:** +0.0071
- **Domain evidence:** 4.00 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 64.9 — Why is GN-z11 Bright, Compact, and Nitrogen Enhanced? Insights from UV Absorption and Emission Diagnostics
- **arXiv:** [2608.12466](https://arxiv.org/abs/2608.12466)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7657 / `stellar_atmospheres_evolution` 0.7408
- **Margin:** +0.0248
- **Domain evidence:** 2.50 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 64.6 — Catalytic formation of H_2 on carbonaceous dust grains - implications for interstellar observations
- **arXiv:** [2608.16149](https://arxiv.org/abs/2608.16149)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7424 / `planetary_disks_exoplanets` 0.7259
- **Margin:** +0.0165
- **Domain evidence:** 2.50 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 64.0 — Beyond Idealized PAHs: Infrared Signatures of Carbon-Chain Defects from Shock Synthesis
- **arXiv:** [2608.18505](https://arxiv.org/abs/2608.18505)
- **Primary:** astro-ph.GA
- **Positive / negative:** `turbulence` 0.7493 / `planetary_disks_exoplanets` 0.7265
- **Margin:** +0.0229
- **Domain evidence:** 2.50 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 63.9 — Diverse ionized gas conditions in a dynamically hot, interacting galaxy at $z = 9.31$ revealed by JWST/NIRSpec IFU
- **arXiv:** [2608.16996](https://arxiv.org/abs/2608.16996)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7572 / `planetary_disks_exoplanets` 0.7538
- **Margin:** +0.0033
- **Domain evidence:** 6.50 (title 0.00)
- **Gate:** B → B — contrastive
...
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7709 / `galaxy_evolution_agn` 0.7480
- **Margin:** +0.0229
- **Domain evidence:** 0.00 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 63.3 — Two domains of extended Lyman-alpha emission around galaxies: from local radiation to environmental regulation
- **arXiv:** [2608.16665](https://arxiv.org/abs/2608.16665)
- **Primary:** astro-ph.GA
- **Positive / negative:** `galactic_ism_surveys` 0.7510 / `galaxy_evolution_agn` 0.7341
- **Margin:** +0.0169
- **Domain evidence:** 1.50 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 62.8 — SPURS: Massive Stars, Dense Gas, and Ly$α$ Escape in GN-z11 at $z = 10.6$
- **arXiv:** [2608.12699](https://arxiv.org/abs/2608.12699)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7630 / `stellar_atmospheres_evolution` 0.7396
- **Margin:** +0.0234
- **Domain evidence:** 1.50 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 62.1 — Differential Reddening and Extinction Law Analyses of Galactic Open Clusters
- **arXiv:** [2608.13313](https://arxiv.org/abs/2608.13313)
- **Primary:** astro-ph.GA
- **Positive / negative:** `galactic_ism_surveys` 0.7629 / `stellar_atmospheres_evolution` 0.7606
- **Margin:** +0.0023
- **Domain evidence:** 3.50 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 61.6 — Diffuse Dwarf Galaxies in Galaxy Clusters: I. Stellar Populations and Radial Gradients
- **arXiv:** [2608.17375](https://arxiv.org/abs/2608.17375)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7487 / `galaxy_evolution_agn` 0.7355
- **Margin:** +0.0132
- **Domain evidence:** 1.50 (title 0.00)
- **Gate:** B → B — contrastive
...
- **Primary:** astro-ph.SR
- **Positive / negative:** `astrochemistry` 0.7516 / `planetary_disks_exoplanets` 0.7188
- **Margin:** +0.0328
- **Domain evidence:** 0.00 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 60.8 — Local Interstellar Flow Parameters from the First Intersection of IMAP-Lo's Parameter Tubes
- **arXiv:** [2608.14939](https://arxiv.org/abs/2608.14939)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7454 / `cosmology_large_scale_structure` 0.7374
- **Margin:** +0.0081
- **Domain evidence:** 2.50 (title 0.00)
- **Gate:** B → B — contrastive
...
- **Primary:** astro-ph.GA
- **Positive / negative:** `galactic_ism_surveys` 0.7435 / `galaxy_evolution_agn` 0.7286
- **Margin:** +0.0149
- **Domain evidence:** 0.00 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 58.7 — The Low-Mass Baryon Cycle in QUEST Dwarf Galaxies I: Sample definition and first results
- **arXiv:** [2608.15782](https://arxiv.org/abs/2608.15782)
- **Primary:** astro-ph.GA
- **Positive / negative:** `astrochemistry` 0.7636 / `galaxy_evolution_agn` 0.7603
- **Margin:** +0.0034
- **Domain evidence:** 2.50 (title 0.00)
- **Gate:** B → B — contrastive
...
- **Primary:** astro-ph.SR
- **Positive / negative:** `astrochemistry` 0.7229 / `cosmology_large_scale_structure` 0.7112
- **Margin:** +0.0117
- **Domain evidence:** 0.00 (title 0.00)
- **Gate:** B → B — contrastive
...
### [B] 57.4 — Radio Properties of Narrow-Line and Broad-Line Seyfert 1 Galaxies
- **arXiv:** [2608.13303](https://arxiv.org/abs/2608.13303)
- **Primary:** astro-ph.GA
- **Positive / negative:** `galactic_ism_surveys` 0.7222 / `galaxy_evolution_agn` 0.7162
- **Margin:** +0.0060
- **Domain evidence:** 1.50 (title 0.00)
- **Gate:** B → B — contrastive
...
## Domain-gate downgrades

- **High Velocity Neutral Gas in the Fermi Bubbles: New Kinematic Limits and Spatial Structure** — A→C; `galaxy_evolution_agn`; evidence 1.00 — [2608.16754](https://arxiv.org/abs/2608.16754)
- **Physics of Circular Polarized Ion-Scale Waves in Hybrid Simulations of Alfvénic Fluctuations** — B→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.14151](https://arxiv.org/abs/2608.14151)
- **Outflows in steep density gradients: diversity of behavior and implications for tidal disruption events and luminous fast blue optical transients** — B→SKIP; `relativistic_plasma_transients`; evidence 0.00 — [2608.19512](https://arxiv.org/abs/2608.19512)
- **The deepest color-magnitude diagrams for the benchmark open cluster NGC 2437 from Gaia and VVVX** — B→SKIP; `planetary_disks_exoplanets`; evidence 1.00 — [2608.14514](https://arxiv.org/abs/2608.14514)
- **A model for the enhanced production rate of early-type hypervelocity stars in the Galactic halo** — C→SKIP; `planetary_disks_exoplanets`; evidence 1.50 — [2608.18475](https://arxiv.org/abs/2608.18475)
- **Large eROSITA X-ray sources as 2MRS galaxy groups** — B→SKIP; `cosmology_large_scale_structure`; evidence 0.00 — [2608.17732](https://arxiv.org/abs/2608.17732)
- **Cosmography with DESI-DR1 Cosmic Chronometers: Direct H(z) measurements from Luminous Red Galaxy ages** — B→SKIP; `galaxy_evolution_agn`; evidence 0.00 — [2608.13178](https://arxiv.org/abs/2608.13178)
- **$\texttt{Aether.jl}$ : A High-Performance 3D MHD and Multifluid Dust Code Written in a Dynamic Language with an Interactive Human-AI Development Framework** — B→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.14048](https://arxiv.org/abs/2608.14048)
- **Tracing Lyman alpha escape in the CRISTAL-02 galaxy at z~5.3** — C→SKIP; `planetary_disks_exoplanets`; evidence 1.50 — [2608.19439](https://arxiv.org/abs/2608.19439)
- **Evolution of lunar wake potentials: structure, energy conversion, and their imprints on velocity distributions** — B→SKIP; `cosmology_large_scale_structure`; evidence 0.00 — [2608.18383](https://arxiv.org/abs/2608.18383)
- **A self-consistent solar coronal heating model by Alfvenic waves** — B→SKIP; `solar_physics`; evidence 0.00 — [2608.15221](https://arxiv.org/abs/2608.15221)
- **Revised $^{45}$V($p,γ$)$^{46}$Cr reaction rate and its impact on the production of $^{44}$Ti in core-collapse supernovae** — B→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.17757](https://arxiv.org/abs/2608.17757)
- **The X-Ray Continuum Emission Region in the Lensed Quasar SDSS J133907.23+131038.6 is Much Smaller than the Accretion Disk** — B→SKIP; `galaxy_evolution_agn`; evidence 0.00 — [2608.17041](https://arxiv.org/abs/2608.17041)
- **Kinematics and Dynamics of the Open Cluster NGC 2302** — B→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.18550](https://arxiv.org/abs/2608.18550)
- **Interpretations of the $10\%$ polarization observed in the early forward-shock afterglow of GRB 091208** — B→SKIP; `generic_mhd_plasma_theory`; evidence 0.00 — [2608.15494](https://arxiv.org/abs/2608.15494)
- **Determining low-$\ell$ p-mode frequency shifts in Sun-like stars: Enhancing the cross-correlation technique with filters** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.15364](https://arxiv.org/abs/2608.15364)
- **Accurately simulating gain and clock-induced charge production in the EMCCD gain register** — B→SKIP; `generic_instrumentation`; evidence 0.00 — [2608.17842](https://arxiv.org/abs/2608.17842)
- **Hector Galaxy Survey: Falling in Between - Infalling Galaxies in the Midst of the Abell 3667 Merger** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.18621](https://arxiv.org/abs/2608.18621)
- **Modelling mountains on accreting magnetized neutron stars** — C→SKIP; `dense_nuclear_matter`; evidence 0.00 — [2608.17508](https://arxiv.org/abs/2608.17508)
- **X-ray thread/Nonthermal Radio Filament associations: Evidence for Interstellar Magnetic Reconnection** — B→SKIP; `planetary_disks_exoplanets`; evidence 1.00 — [2608.14830](https://arxiv.org/abs/2608.14830)
- **Ejecta clumps revealed by study of reverse-shocked ejecta through MUSE integral field spectroscopy of SNR 0509-67.5** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.17465](https://arxiv.org/abs/2608.17465)
- **Polarization of GRB standard X-ray afterglow and its detection prospects by eXTP** — C→SKIP; `relativistic_plasma_transients`; evidence 0.00 — [2608.15503](https://arxiv.org/abs/2608.15503)
- **Multi-zone Modeling of Blazar Jets: Constraints from GeV-Optical Correlation and Short-Timescale Variability** — B→SKIP; `relativistic_plasma_transients`; evidence 0.00 — [2608.18707](https://arxiv.org/abs/2608.18707)
- **Correlations with Magnetic Activity in the Solar Near-Surface Shear Layer. I. Rotation** — B→SKIP; `generic_mhd_plasma_theory`; evidence 0.00 — [2608.19438](https://arxiv.org/abs/2608.19438)
- **The Total and Polarized Radio Emission from the Innermost Jets of a High-Redshift Quasar and a Candidate at Parsec-Scale Resolution** — C→SKIP; `generic_mhd_plasma_theory`; evidence 0.00 — [2608.18691](https://arxiv.org/abs/2608.18691)
- **The FLARE Facility** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.17332](https://arxiv.org/abs/2608.17332)
- **No Evidence for Nearby Circumstellar Material in the Type Ia Supernova 2025rbs** — B→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.13655](https://arxiv.org/abs/2608.13655)
- **Extreme-Mass-Ratio Inspirals in Gaseous Disks** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.17003](https://arxiv.org/abs/2608.17003)
- **Time-dependent Evolution of Proton Spectra in Supernova Remnants and Their Contribution to Galactic Cosmic Rays** — C→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.18481](https://arxiv.org/abs/2608.18481)
- **H-$α$ Integral Carrington Synoptic Maps Produced by NSO/NISP** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.13812](https://arxiv.org/abs/2608.13812)
- **Asteroseismic analysis of red giants in eclipsing binaries using two methods: implications for scaling relations and chemical composition** — B→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.18250](https://arxiv.org/abs/2608.18250)
- **Sr and Ba yields of the First Generation(s) of stars: Constraints from metal-poor stars** — B→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.17001](https://arxiv.org/abs/2608.17001)
- **JWST Detects a Dusty AGB-like Source Before the Type Ia-CSM Supernova 2026sqf** — C→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.13321](https://arxiv.org/abs/2608.13321)
- **Simulation of advective accretion flows around black holes under various outer boundary conditions** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.18860](https://arxiv.org/abs/2608.18860)
- **A stochastic forward model for the intergalactic dispersion-measure distribution of Fast Radio Bursts** — B→SKIP; `galaxy_evolution_agn`; evidence 0.00 — [2608.17658](https://arxiv.org/abs/2608.17658)
- **The initial evolution of SN 2011dh: The importance of inhomogeneities** — B→SKIP; `cosmology_large_scale_structure`; evidence 0.00 — [2608.17736](https://arxiv.org/abs/2608.17736)
- **The Inbound Gas and Dust Evolution of Interstellar Comet 3I/ATLAS from Optical Spectroscopy and Multi-band Photometry** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.18371](https://arxiv.org/abs/2608.18371)
- **Variable Star Polarimetry with PICSARR-2** — C→SKIP; `generic_instrumentation`; evidence 0.00 — [2608.18051](https://arxiv.org/abs/2608.18051)
- **Broadband emission of microquasar remnants** — B→SKIP; `cosmology_large_scale_structure`; evidence 0.00 — [2608.17000](https://arxiv.org/abs/2608.17000)
- **Probing the $γ$-ray emission region and the connection to jet ejections in NRAO 150 with VLBI** — C→SKIP; `relativistic_plasma_transients`; evidence 0.00 — [2608.16981](https://arxiv.org/abs/2608.16981)
- **The SAMI Galaxy Survey: Linking Tidal Features and Orbit Populations Using Schwarzschild Modelling** — B→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.14012](https://arxiv.org/abs/2608.14012)
- **Origin of nucleosynthetic isotope variability in the NC reservoir: Evidence from Ti, Cr, and Mo isotopes** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.19786](https://arxiv.org/abs/2608.19786)
- **A High-Resolution Spectroscopic Survey of Directly Imaged Companion Hosts: III. Characterization of the Cold Imaged Planet Hosts AF Lep A and $ε$ Indi A** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.15912](https://arxiv.org/abs/2608.15912)
- **Improved constraints on the Milky Way potential using the M68 stream and DESI spectroscopic data** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.15334](https://arxiv.org/abs/2608.15334)
- **The Gamma-ray Burst Jet Energy Distribution Suggests A Quasi-universal, Weakly Magnetized Jet Evolving Over Cosmic Time** — C→SKIP; `compact_objects_transients`; evidence 0.00 — [2608.16991](https://arxiv.org/abs/2608.16991)
- **Exact spherical-wave forward model for radio reflection from stratified media** — C→SKIP; `solar_physics`; evidence 0.00 — [2608.15989](https://arxiv.org/abs/2608.15989)
- **The atmospheric vertical structure of Uranus and Neptune from thermochemical models: the impact of model assumptions** — C→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.13157](https://arxiv.org/abs/2608.13157)
- **Diversity of Ionized Gas Structures in Nearby Metal-poor Dwarf Galaxies** — B→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.19667](https://arxiv.org/abs/2608.19667)
- **Multi-lane type II radio bursts: Insights into shock propagation in the corona** — B→SKIP; `solar_physics`; evidence 0.00 — [2608.19295](https://arxiv.org/abs/2608.19295)
- **Observations of Disrupted CME Material Falling Back Into the Low Corona** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.17951](https://arxiv.org/abs/2608.17951)
- **The Atacama Cosmology Telescope: Passband Measurements with an Analysis of Systematic Errors** — C→SKIP; `generic_instrumentation`; evidence 0.00 — [2608.18348](https://arxiv.org/abs/2608.18348)
- **pynucastro 3: A community library for nuclear astrophysics** — C→SKIP; `dense_nuclear_matter`; evidence 0.00 — [2608.17049](https://arxiv.org/abs/2608.17049)
- **JWST/NIRSpec Spectra for Three Ultracool Brown Dwarfs Detected in Extragalactic Surveys: Further Evidence for Phosphine Absorption** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.14786](https://arxiv.org/abs/2608.14786)
- **Evidence for the First Globular Cluster Stellar Stream beyond the Milky Way** — C→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.12254](https://arxiv.org/abs/2608.12254)
- **Revisiting the Growth Rate of the Relativistic Tearing Instability: The Role of the Non-ideal MHD Structure** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.19645](https://arxiv.org/abs/2608.19645)
- **XRISM reveals sloshing-driven gas motions in the core of Abell 2029** — C→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.14415](https://arxiv.org/abs/2608.14415)
- **The fraction of periodic SN Ib/c light curves** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.18207](https://arxiv.org/abs/2608.18207)
- **A Critical Eddington Ratio for X-Shaped Radio Galaxies** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.16976](https://arxiv.org/abs/2608.16976)
- **Detection of Aliphatically Deuterated Aromatic Hydrocarbons in the Large Magellanic Cloud 30 Doradus Star-Forming Complex** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.14984](https://arxiv.org/abs/2608.14984)
- **Tropospheric Ducting Prediction based on GFS Model Data at Inyarrimanha Ilgari Bundara, the CSIRO Murchison Radio-astronomy Observatory** — C→SKIP; `generic_instrumentation`; evidence 0.00 — [2608.12861](https://arxiv.org/abs/2608.12861)
- **High-energy neutrino signatures of embedded GRB jets in AGN disks: a dynamic jet-propagation framework** — C→SKIP; `relativistic_plasma_transients`; evidence 0.00 — [2608.12217](https://arxiv.org/abs/2608.12217)
- **Millimeter-wave adaptive optics: Demonstrating closed-loop correction for lowest Zernike modes** — C→SKIP; `generic_instrumentation`; evidence 0.00 — [2608.16548](https://arxiv.org/abs/2608.16548)
- **Simulating Zernike-based CWFS with HCIPy** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.17097](https://arxiv.org/abs/2608.17097)
- **Tracking nonlinear solar-wind dynamics over three solar cycles using Wind observations** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.17037](https://arxiv.org/abs/2608.17037)
- **SCExAO/CHARIS High-Contrast Pre-Launch Vetting of Roman Coronagraph Technology Demonstration PSF Reference Stars** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.17008](https://arxiv.org/abs/2608.17008)
- **Laser-micromachined silicon-platelet feedhorns for large-scale submillimeter and millimeter-wave focal planes** — C→SKIP; `generic_instrumentation`; evidence 0.00 — [2608.12577](https://arxiv.org/abs/2608.12577)
- **The Roman Coronagraph Community Participation Program: corgisim - a simulation suite for the Nancy Grace Roman Space Telescope Coronagraph Instrument** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.17257](https://arxiv.org/abs/2608.17257)
- **FLAGS II: Constraining Galaxy Formation Models with Dimensionality Reduction of Direct Observables** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.12471](https://arxiv.org/abs/2608.12471)
- **Plasma Turbulence in the Lunar Environment Across Solar Wind and Magnetotail Conditions: Observations from Chandrayaan-2 Radio Science experiment** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.15512](https://arxiv.org/abs/2608.15512)
- **Informing spectral models for dense plasmas with K-edge absorption measurements of warm dense copper** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.19382](https://arxiv.org/abs/2608.19382)
- **VAPOLA - A multiyear, multiband polarization survey of AGNs and Sgr A* at millimeter wavelengths with ALMA II. Spectropolarimetric properties and their evolution from 2017 to 2023** — C→SKIP; `generic_instrumentation`; evidence 0.00 — [2608.14900](https://arxiv.org/abs/2608.14900)
- **Interacting stellar winds feeding Sgr A*: from the system of mass-losing stars to the binary IRS 16SW** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.16993](https://arxiv.org/abs/2608.16993)
- **Millimeter and sub-millimeter characterization of polymers used for infrared filters in high-sensitivity cryogenic microwave telescopes** — C→SKIP; `generic_instrumentation`; evidence 0.00 — [2608.18793](https://arxiv.org/abs/2608.18793)
- **A deep learning algorithm for black hole spin estimation using hot-spot secondary images** — C→SKIP; `generic_instrumentation`; evidence 0.00 — [2608.18208](https://arxiv.org/abs/2608.18208)
- **Low Ly$α$ Visibility in Galaxy Overdensities: Reionization Topology and Neutral-Fraction Ceilings from DIVER over $4.8<z<11$** — C→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.19311](https://arxiv.org/abs/2608.19311)
- **X-ray Flaring and Variability in NGC 1275, the Heart of the Perseus Cluster** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.13281](https://arxiv.org/abs/2608.13281)
- **The Wave-Regulated Precursor of a Near-Parallel Interplanetary Shock Observed by Parker Solar Probe** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.12606](https://arxiv.org/abs/2608.12606)
- **The Kick Velocities of Neutron Stars in Binary Systems** — C→SKIP; `planetary_disks_exoplanets`; evidence 0.00 — [2608.19690](https://arxiv.org/abs/2608.19690)
- **Quasar Impostors: Two Extremely UV-Bright ($M_{\rm UV}\approx-23.5$) Reionisation-Epoch Galaxies Powered by Very Massive Stars** — C→SKIP; `stellar_atmospheres_evolution`; evidence 0.00 — [2608.18212](https://arxiv.org/abs/2608.18212)
- **The Production of Electron-Capture Elements in Thermonuclear Supernovae: Theory vs. Observations** — C→SKIP; `dense_nuclear_matter`; evidence 0.00 — [2608.13432](https://arxiv.org/abs/2608.13432)

## Domain-evidence rescues

- **The THESAN-ZOOM project: clumpiness of high-redshift galaxies and its connection to bursty star formation** — C→B; evidence 6.75 — [2608.19308](https://arxiv.org/abs/2608.19308)
- **Trace the Self-Gravitating Gas Using CO Isotopologues** — SKIP→C; evidence 7.00 — [2608.12473](https://arxiv.org/abs/2608.12473)
- **A comprehensive cluster census of Orion. An application of the Significance Mode Analysis (SigMA) algorithm** — SKIP→C; evidence 6.00 — [2608.16989](https://arxiv.org/abs/2608.16989)

## Old keyword selected, v2.2 SKIP

- **Revised $^{45}$V($p,γ$)$^{46}$Cr reaction rate and its impact on the production of $^{44}$Ti in core-collapse supernovae** — [2608.17757](https://arxiv.org/abs/2608.17757)
- **Ejecta clumps revealed by study of reverse-shocked ejecta through MUSE integral field spectroscopy of SNR 0509-67.5** — [2608.17465](https://arxiv.org/abs/2608.17465)
- **Asteroseismic analysis of red giants in eclipsing binaries using two methods: implications for scaling relations and chemical composition** — [2608.18250](https://arxiv.org/abs/2608.18250)
- **The Inbound Gas and Dust Evolution of Interstellar Comet 3I/ATLAS from Optical Spectroscopy and Multi-band Photometry** — [2608.18371](https://arxiv.org/abs/2608.18371)
- **Variable Star Polarimetry with PICSARR-2** — [2608.18051](https://arxiv.org/abs/2608.18051)
- **A High-Resolution Spectroscopic Survey of Directly Imaged Companion Hosts: III. Characterization of the Cold Imaged Planet Hosts AF Lep A and $ε$ Indi A** — [2608.15912](https://arxiv.org/abs/2608.15912)
- **Concerns regarding recurrent fluorescence's impact on smaller diffuse ISM aromatics** — [2608.17886](https://arxiv.org/abs/2608.17886)
- **JWST/NIRSpec Spectra for Three Ultracool Brown Dwarfs Detected in Extragalactic Surveys: Further Evidence for Phosphine Absorption** — [2608.14786](https://arxiv.org/abs/2608.14786)
- **XRISM reveals sloshing-driven gas motions in the core of Abell 2029** — [2608.14415](https://arxiv.org/abs/2608.14415)
- **Detection of Aliphatically Deuterated Aromatic Hydrocarbons in the Large Magellanic Cloud 30 Doradus Star-Forming Complex** — [2608.14984](https://arxiv.org/abs/2608.14984)
- **SCExAO/CHARIS High-Contrast Pre-Launch Vetting of Roman Coronagraph Technology Demonstration PSF Reference Stars** — [2608.17008](https://arxiv.org/abs/2608.17008)
- **Interacting stellar winds feeding Sgr A*: from the system of mass-losing stars to the binary IRS 16SW** — [2608.16993](https://arxiv.org/abs/2608.16993)
- **TomoSphero: Fast Differentiable Projector for Planetary and Solar Tomography on Spherical Grids** — [2608.16960](https://arxiv.org/abs/2608.16960)
- **Nuclear Drip Line and the Composition of Supernova Matter** — [2608.16778](https://arxiv.org/abs/2608.16778)
- **Investigating the properties of nearby young moving groups using GaiaDR3** — [2608.18596](https://arxiv.org/abs/2608.18596)
- **Panchromatic JWST Observations and Models of the Dim Type Iax Supernova 2024vjm at 200 days** — [2608.15040](https://arxiv.org/abs/2608.15040)
- **From Variability to SED Modeling: A Multiwavelength Study of the Neutrino Blazar TXS 0506+056** — [2608.17526](https://arxiv.org/abs/2608.17526)
- **Radio Monitoring of Classical Novae using the ASKAP Variable and Slow Transients Survey** — [2608.13330](https://arxiv.org/abs/2608.13330)
- **ALMA high resolution observations of Betelgeuse: Persistent structure spanning the inner atmosphere** — [2608.19339](https://arxiv.org/abs/2608.19339)
- **The instantaneous mass accretion rate of novae in quiescence: - an archival ultraviolet optical spectral analysis** — [2608.18037](https://arxiv.org/abs/2608.18037)
- **Recurrent Multi-year Mg II BAL Variability in SDSS J1333+0012** — [2608.18211](https://arxiv.org/abs/2608.18211)
- **Asteroseismology of the multiperiodic field SX Phe pulsator BL Camelopardalis** — [2608.19076](https://arxiv.org/abs/2608.19076)
- **Early Planet Formation in Embedded Disks (eDisk). XXIV: Systematic Investigation of Disk Structures based on Visibility Analysis** — [2608.19364](https://arxiv.org/abs/2608.19364)
- **Gaia DR3 Limits on Stellar Engine Technosignatures in Nearby Stars** — [2608.16060](https://arxiv.org/abs/2608.16060)
- **JWST-MIRI's multi-dimensional view of mass loss in the irradiated disks of NGC 1977** — [2608.17226](https://arxiv.org/abs/2608.17226)
- **Machine Learning in Application to Automatic Noise Processing of Solar Spectrograms** — [2608.16392](https://arxiv.org/abs/2608.16392)
- **Eta Carinae's historical light curve: evidence for cyclic Roche lobe overflow from the primary star** — [2608.16818](https://arxiv.org/abs/2608.16818)
- **Radiation damage to the Hubble Space Telescope has been several years out of phase with the Solar cycle** — [2608.18214](https://arxiv.org/abs/2608.18214)
- **TIC 433545934: The first 2+2 type doubly eclipsing binary with extra, mutual eclipses** — [2608.13034](https://arxiv.org/abs/2608.13034)
- **The Roman Coronagraph Community Participation Program: pre-launch reference star list and impact of reference star properties on post-processing performance** — [2608.17057](https://arxiv.org/abs/2608.17057)
- **From the Earth to the Sun** — [2608.13635](https://arxiv.org/abs/2608.13635)
- **Responses of the X-ray spectrometer/imager STIX onboard Solar Orbiter** — [2608.19420](https://arxiv.org/abs/2608.19420)
- **Astronomical Cardiology II: A Search For Heartbeat Stars Using APOGEE and TESS** — [2608.12474](https://arxiv.org/abs/2608.12474)
- **Could John Ellard Gore have pre-empted the Hertzsprung-Russell diagram?** — [2608.18799](https://arxiv.org/abs/2608.18799)
- **Are Hot Jupiters Tidally Disrupted During Stellar Main Sequence?** — [2608.12790](https://arxiv.org/abs/2608.12790)
- **Hydrodynamics modeling of the water snow line in young protoplanetary disks with dust-size-dependent opacities** — [2608.17921](https://arxiv.org/abs/2608.17921)
- **Revisiting gravitational instability in protostellar discs with improved radiative cooling models** — [2608.13058](https://arxiv.org/abs/2608.13058)
- **A Catalog of Homogeneously Derived Stellar Parameters for Spectroscopic Survey Stars** — [2608.17734](https://arxiv.org/abs/2608.17734)
- **SN 2023gfo: A Peculiar Type IIP Supernova with High Luminosity and Normal Plateau Duration** — [2608.16006](https://arxiv.org/abs/2608.16006)
- **Stellar tidal systematics in apsidal-motion searches for circumbinary planets: CH Ind and SW CMa** — [2608.13269](https://arxiv.org/abs/2608.13269)
- **Stability of circumbinary orbits in misaligned triple star systems** — [2608.15316](https://arxiv.org/abs/2608.15316)
- **A metallicity sweet spot for disc fragmentation and planet formation** — [2608.18830](https://arxiv.org/abs/2608.18830)
- **Planetary systems in the light of asteroseismology: metallicity threshold for the planetary systems and age-metallicity relation** — [2608.15849](https://arxiv.org/abs/2608.15849)
- **Are Near Resonant Multiple-planet Systems from Kepler Young?** — [2608.12786](https://arxiv.org/abs/2608.12786)
- **Toward Operational Solar Flare Peak Flux Nowcasting: A Strategy Combining Real-Time Data, Machine Learning, and NOAA Flare Detection Criteria** — [2608.20062](https://arxiv.org/abs/2608.20062)
- **Stellar Abundances as Probes of Rocky Exoplanet Interiors: The Mantle Composition and Mineralogy of GJ 486b** — [2608.18457](https://arxiv.org/abs/2608.18457)
- **Substructure evolution from protoplanetary to debris disks driven by mutually gravitating planetesimals and implications on Kepler resonances and free-floating planets** — [2608.19329](https://arxiv.org/abs/2608.19329)

## v2.2 A/B, old keyword missed

- **[A] 81.8 — CHANG-ES XL: Magnetic Field Structures in the Disk and Halo of NGC 891** — `magnetic_fields` — [2608.12275](https://arxiv.org/abs/2608.12275)
- **[A] 74.1 — Impact of Upstream Clumpiness on Supernova Remnant Forward Shock Evolution in Molecular Cloud Environments** — `turbulence` — [2608.17477](https://arxiv.org/abs/2608.17477)
- **[A] 71.1 — Star Formation in the H II Region Sh 2-205: 3D Morphology and Kinematics from Young Stars and Molecular Gas** — `astrochemistry` — [2608.16179](https://arxiv.org/abs/2608.16179)
- **[B] 72.5 — The efficient star-forming regions of stripped-envelope supernovae** — `astrochemistry` — [2608.18897](https://arxiv.org/abs/2608.18897)
- **[B] 72.1 — Diffuse HI emission in the circumgalactic medium of NGC891 and NGC4565 - III: azimuthal profiles** — `galactic_ism_surveys` — [2608.19186](https://arxiv.org/abs/2608.19186)
- **[B] 70.7 — Multiphase turbulence as the origin of OH+, H2O+ and H3+ column density scatter in the local ISM** — `astrochemistry` — [2608.15633](https://arxiv.org/abs/2608.15633)
- **[B] 68.3 — High-spectral-resolution Observations of the [S II] Emission-line Doublet in the Filamentary Nebula Surrounding NGC 1275** — `turbulence` — [2608.14888](https://arxiv.org/abs/2608.14888)
- **[B] 67.5 — Chromospheric heating and magnetic topology above the shared penumbra of a delta-spot: Multi-line inversions and multi-height magnetic-field extrapolations** — `magnetic_fields` — [2608.19983](https://arxiv.org/abs/2608.19983)
- **[B] 66.8 — The THESAN-ZOOM project: clumpiness of high-redshift galaxies and its connection to bursty star formation** — `massive_star_formation` — [2608.19308](https://arxiv.org/abs/2608.19308)
- **[B] 66.0 — Aromatics and Aliphatics in Local Star-Forming Galaxies as Probed by AKARI** — `astrochemistry` — [2608.14989](https://arxiv.org/abs/2608.14989)
- **[B] 65.1 — OH Line Detections in Southern Galaxies of the IRAS Revised Bright Galaxy Sample** — `galactic_ism_surveys` — [2608.14473](https://arxiv.org/abs/2608.14473)
- **[B] 65.0 — The segmented spiral structure of the Solar neighbourhood traced by young clustered populations** — `galactic_ism_surveys` — [2608.17887](https://arxiv.org/abs/2608.17887)
- **[B] 64.9 — Why is GN-z11 Bright, Compact, and Nitrogen Enhanced? Insights from UV Absorption and Emission Diagnostics** — `astrochemistry` — [2608.12466](https://arxiv.org/abs/2608.12466)
- **[B] 63.7 — ALMA observations of pre-JWST z ~ 10 galaxy candidates: A CO(J = 9-8) line from a ULIRG at z = 2.54 and revisit of the photometric redshifts with JWST photometry** — `astrochemistry` — [2608.12708](https://arxiv.org/abs/2608.12708)
- **[B] 63.3 — Two domains of extended Lyman-alpha emission around galaxies: from local radiation to environmental regulation** — `galactic_ism_surveys` — [2608.16665](https://arxiv.org/abs/2608.16665)
- **[B] 62.8 — SPURS: Massive Stars, Dense Gas, and Ly$α$ Escape in GN-z11 at $z = 10.6$** — `astrochemistry` — [2608.12699](https://arxiv.org/abs/2608.12699)
- **[B] 62.1 — Differential Reddening and Extinction Law Analyses of Galactic Open Clusters** — `galactic_ism_surveys` — [2608.13313](https://arxiv.org/abs/2608.13313)
- **[B] 61.6 — Diffuse Dwarf Galaxies in Galaxy Clusters: I. Stellar Populations and Radial Gradients** — `astrochemistry` — [2608.17375](https://arxiv.org/abs/2608.17375)
- **[B] 61.4 — Radio Properties of RS Canum Venaticorum Variables in VLASS and RACS** — `astrochemistry` — [2608.13653](https://arxiv.org/abs/2608.13653)
- **[B] 58.7 — The Low-Mass Baryon Cycle in QUEST Dwarf Galaxies I: Sample definition and first results** — `astrochemistry` — [2608.15782](https://arxiv.org/abs/2608.15782)
- **[B] 58.7 — Hemispheric Asymmetry of Solar Active Regions Arises from a Nested Population** — `astrochemistry` — [2608.12263](https://arxiv.org/abs/2608.12263)
- **[B] 57.4 — Radio Properties of Narrow-Line and Broad-Line Seyfert 1 Galaxies** — `galactic_ism_surveys` — [2608.13303](https://arxiv.org/abs/2608.13303)
